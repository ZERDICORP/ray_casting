...
void drawWalls(sf::RenderWindow& window, std::vector<Ray>& rays, float fAngle, float fFovHalf, float fRayStep, float fDistToProjectionPlane,
	float fShadeIntensity, float fShadeMultiplier, int iWallHCoeff, int iWallSliceW);
